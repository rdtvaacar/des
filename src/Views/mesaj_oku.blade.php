            ...
            <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                    <div class="mailbox-read-info">
                        <h3><span style="color: #1b6cbe"><?php echo $mesaj->name ?></span> - <?php echo $mesaj->konu ?></h3>
                    ...
                    <div class="mailbox-controls with-border text-center">
                        <div class="btn-group">
                            ...
                            <a href="/destek/yeni_mesaj?mesaj_id=<?php echo $mesaj_id ?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-container="body" title="Cevapla">
